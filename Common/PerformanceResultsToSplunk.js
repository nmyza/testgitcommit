...
var testEnv = casper.cli.get("testEnvironment");
var baseUrl = casper.cli.get("baseUrl");
var moduleName = casper.cli.get("module");
var performanceResultsToSplunkFile = casper.cli.get("performanceResultsToSplunkFile");
casper.test.begin("PerformanceResultsToSplunk", function(test) {
    ...
    for (i = 1; i <= lines.length-3; i++) {
        ...
        TestCaseData = {
            ...
            "testEnv": testEnv,
            "baseUrl": baseUrl,
            "performanceResultsToSplunkFile": performanceResultsToSplunkFile,
